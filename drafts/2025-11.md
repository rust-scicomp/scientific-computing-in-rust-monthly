...
This paper presents `GlobalSearch-rs`, an open-source global optimization library written in Rust that implements
a multistart optimization strategy. 
...
package for encoding, manipulating, and analysing binary phylogenetic trees. 
