...
### [interpn 0.11.2](https://crates.io/crates/interpn)

InterpN is a crate allowing N-dimensional interpolation/extrapolation methods.
...
See also the recent
[talk by James Logan](https://youtu.be/7F2YwH0FYbI) for details on InterpN.
...
This release adds an automatic differentiation engine using `std::autodiff` (Enzyme, nightly only), 
a Pounce backend, IIS support, pretty-printing, and many other improvements including bug fixes, and quality-of-life changes.

### [syn 3.0.3](https://crates.io/crates/syn)

One of the most downloaded crates got a major update.
...
A full changelog can be found [here](https://github.com/dtolnay/syn/releases/tag/3.0.0).
...
### [Matsakis N., Battery packs: Let's talk about crates, baby](https://smallcultfollowing.com/babysteps/blog/2026/07/15/battery-packs/)

Battery packs are an idea Niko has been kicking around
on how to curate "starter packs" of crates for specific topics.
This could surely be very interesting for scientific computing in Rust.
