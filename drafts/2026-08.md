...
### [delaunay v0.8.0](https://crates.io/crates/delaunay)

Delaunay is a dimension-generic Rust library for robust Delaunay triangulations
and convex hulls. Version 0.8.0 adds prototype spherical triangulation on S²
and S³, expands validation from four to five levels, and introduces Pachner-move
feasibility checks, validated mesh and visualization exports, and notebook-backed
example workflows. The release also makes topology edits failure-atomic, tightens
APIs around validated inputs and invariant-bearing types, and includes breaking
API changes. Version 0.8.0 requires Rust 1.97.1 or newer.
