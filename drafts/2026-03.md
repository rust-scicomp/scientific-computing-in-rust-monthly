...
Cherry is a Ray Tracer GUI written in Rust that allows for ray tracing in the browser. 
An updated version of Cherry has recently been published. It now uses egui, an immediate 
mode GUI environment for Rust with WASM support, to serve the user interace. 
