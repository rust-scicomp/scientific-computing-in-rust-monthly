...
A deep-dive on ray-surface intersection calculation with the Newton-Raphson algorithm from a mathematical point of view but also. 
The article also discusses how debugging using the `tracing` crate helped in finding the issue and improving the [Cherry ray tracer](https://kmdouglass.github.io/cherry/).
