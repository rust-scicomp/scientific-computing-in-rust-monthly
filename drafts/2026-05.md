...
### [burn v0.21.0](https://crates.io/crates/burn)

After five pre-releases over the last three months, `burn` v0.21.0
...
[on the GitHub release page](https://github.com/tracel-ai/burn/releases/tag/v0.21.0).
...
### [rayon v1.12.0](https://crates.io/crates/rayon)

This new version of `rayon` contains a bug fix in parallel `Range<char>`
and added a new method `ParallelSlice::par_array_windows`.
Details can be found
[in the release notes](https://github.com/rayon-rs/rayon/blob/main/RELEASES.md).
...
<brief description>
-->
### [Keller Mark S. and Gehlenborg Nils, Pluot: Towards 'write once, run everywhere' visualization software, arXiv 2605.14118](https://doi.org/10.48550/arXiv.2605.14118)
